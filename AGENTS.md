# Experience Vault Project Rules

This repository is the portable source of truth for the user's Experience Vault, bundled skills, restore guides, and durable rule templates.

## Experience Vault

Use `/home/l30002999/experience-vault` as the default local checkout when working on this server. In other environments, use the restored checkout path selected by the user or the restore guide.
...
- Global behavior constraints that should affect future agents belong in user rules, this project-level rule file when working in this repository, or an installed skill.
